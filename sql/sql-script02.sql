CREATE DATABASE  IF NOT EXISTS `events_planner_db`;
USE `events_planner_db`;
...
INSERT INTO `location` VALUES (1,'Test','Test',100,20,50,'Test','Test','Test','Test','Test','Test','Test','Test',''),(2,'Test','Test',150,30,60,'Test','Test','Test','Test','Test','Test','Test','Test','');
...
CREATE TABLE `request_info` (
  ...
  `customer_id` int NOT NULL,
  `location_id` int NOT NULL,
  PRIMARY KEY (`id`,`customer_id`,`location_id`),
...
-- Dump completed on 2020-05-26 10:38:02
